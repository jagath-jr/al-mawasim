      ...
      <div className="relative z-20 bg-[#FDFBF7] rounded-t-[2.5rem] shadow-[0_-10px_40px_rgba(0,0,0,0.05)]">
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-24 grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-16 overflow-hidden">
          ...
          <motion.div 
            ...
            className="lg:col-span-2 bg-[#F5F0E6] p-8 md:p-12 rounded-[2rem] border border-[#EAE1D0]"
          >
            ...
            <form className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-5">
                <div>
                  ...
                  <input 
                    ...
                    className="w-full px-4 py-3.5 rounded-lg border border-[#EAE1D0] focus:outline-none focus:border-[#C5A869] focus:ring-1 focus:ring-[#C5A869] bg-white transition-all placeholder:text-gray-400" 
                  />
                </div>
                <div>
              ...
              <div className="h-full flex flex-col">
                ...
                <textarea 
                  ...
                  className="w-full flex-grow min-h-[150px] md:min-h-0 px-4 py-3.5 rounded-lg border border-[#EAE1D0] focus:outline-none focus:border-[#C5A869] focus:ring-1 focus:ring-[#C5A869] bg-white resize-none transition-all placeholder:text-gray-400"
                ></textarea>
              </div>
              ...
              <div className="md:col-span-2 pt-2">
                <motion.button 
                  ...
                  whileTap={{ scale: 0.98 }}
                  type="submit" 
                  className="bg-[#C5A869] text-[#1A1A1A] hover:text-[#FDFBF7] px-8 py-3.5 rounded-lg font-medium hover:bg-[#9C7C3E] transition-colors shadow-sm"
                >
                  Send Message
                </motion.button>
              </div>
          ...
          >
            ...
            <motion.div 
              ...
              className="relative w-full h-[220px] rounded-2xl overflow-hidden shadow-sm border border-[#EAE1D0]"
            >
              <Image 
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-[#1A1A1A]/80 via-[#1A1A1A]/10 to-transparent flex items-end justify-center pb-5">
                <p className="text-[#FDFBF7] font-medium text-sm tracking-wide">
                  Mon - Fri 08.00 - 18.00
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <motion.div variants={fadeInUp} className="flex gap-3 items-start group">
                <MapPin className="w-5 h-5 text-[#C5A869] mt-0.5 group-hover:scale-110 transition-transform" strokeWidth={2} />
                <div>
              ...
              <motion.div variants={fadeInUp} className="flex gap-3 items-start group">
                <Mail className="w-5 h-5 text-[#C5A869] mt-0.5 group-hover:scale-110 transition-transform" strokeWidth={2} />
                <div>
              ...
              <motion.div variants={fadeInUp} className="flex gap-3 items-start group">
                <Phone className="w-5 h-5 text-[#C5A869] mt-0.5 group-hover:scale-110 transition-transform" strokeWidth={2} />
                <div>
