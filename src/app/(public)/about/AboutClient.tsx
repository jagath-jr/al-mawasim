...
export default function AboutClient({ initialData }: AboutClientProps) {
  ...
  const aboutConfig = initialData?.aboutConfig || {};
  
  // You can map your CMS content blocks here in the future.
  // For now, we preserve your static arrays as fallbacks to maintain the UI.
  const features = [
    {
    ...
    <main className="relative min-h-screen overflow-x-hidden w-full bg-[#f8f9fc56]">      
      ...
      */}
      <div className="fixed top-0 left-0 w-full h-screen -z-10 bg-[linear-gradient(90deg,rgba(110,95,165,0.75)_0%,rgba(255,255,255,0)_100%)]">
        <Image
          src="/about-us/aboutus-bg-img.webp" 
