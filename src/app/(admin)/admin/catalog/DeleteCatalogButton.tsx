...
export default function DeleteCatalogButton({ id }: { id: string }) {
  ...
  const handleDelete = () => {
    if (window.confirm("Delete this catalog permanently?")) {
  ...
  return (
    <button 
      ...
      disabled={isPending} 
      className="w-full h-full flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed"
