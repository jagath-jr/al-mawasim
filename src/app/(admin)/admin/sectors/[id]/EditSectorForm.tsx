  ...
  return (
    <div className="max-w-2xl mx-auto pb-20">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-3xl font-bold text-gray-800">Edit Sector</h2>
      ...
      <form onSubmit={handleSubmit} className="bg-white p-6 rounded-lg shadow-md space-y-6">
        ...
        <div className="flex items-center space-x-3 bg-gray-50 p-4 rounded-md border border-gray-200">
          <input type="checkbox" name="isActive" id="isActive" defaultChecked={sector.isActive} className="h-5 w-5 text-blue-600 focus:ring-blue-500 border-gray-300 rounded" />
